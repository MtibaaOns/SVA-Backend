...
public class contratService {
    ...
    public contrat updateContrat(contrat contrat, Long numcontart, LocalDate dateDebut, LocalDate dateFin, Integer nbInterMois, Integer nbInterAnnee, Long mtForfaitaire) {
