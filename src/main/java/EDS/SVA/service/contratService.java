...
public class contratService {
    ...
    public contrat updateContrat(contrat contrat, Long numcontart, String dateDebut, String dateFin, Integer nbInterMois, Integer nbInterAnnee, Long mtForfaitaire) {
